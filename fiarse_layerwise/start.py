...
def new_arguments(parser):
    # Method description
    parser.add_argument('--method', type=str, default='FIARSE_layerwise', help='Running algorithm')
...
if __name__ == "__main__":
    ...
    # Load Dataset 
    dataset_server = dataset.ServerLoader(parser=parser, 
                                            partitioner=args.partitioner, 
                                            workers=workers, 
                                            dataset_root=args.root)
    dataset_client = dataset.ClientLoader(parser=parser, 
                                            partitioner=args.partitioner, 
